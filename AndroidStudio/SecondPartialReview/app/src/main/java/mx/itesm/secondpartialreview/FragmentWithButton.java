...
public class FragmentWithButton extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_fragment_with_button, container, false);
        Button button = (Button) v.findViewById(R.id.fragment_button);
        final TextView textView = (TextView) v.findViewById(R.id.fragment_text);
        final EditText input = (EditText) v.findViewById(R.id.fragment_input);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                textView.setText(input.getText().toString());
                mListener.toastText(mParam1,mParam2);
            }
        });
        return v;
    }
